...
export const MobileHeader = () => {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-40 flex h-16 items-center justify-between border-b bg-[#fffaf1]/92 px-5 backdrop-blur-xl lg:hidden"><Link href="/"><BrandMark /></Link><span className="rounded-full bg-[#e8f6f3] px-3 py-1.5 text-[10px] font-black uppercase tracking-wider text-[#267c74]">Học English</span></header>
