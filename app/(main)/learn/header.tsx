...
export const Header = ({ title }: { title: string }) => (
  <div className="mb-7 flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
    <div><p className="eyebrow">Studio tiếng Anh</p><h1 className="display-title mt-3">Sẵn sàng cho 10 phút hôm nay?</h1><p className="mt-3 text-sm text-[#6d7e8c]">{title} · Học từng tình huống, dùng được từng câu.</p></div>
